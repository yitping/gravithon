...
for mode in modes:
	...
	fname_fits="IMAGING_DETECTOR_SC_"+mode+".fits"

	exthdr=fits.Header()
	exthdr['EXTNAME'] = 'IMAGING_DETECTOR_SC'
	...
	exthdr['NUM_DIM'] = 2
	exthdr['MAXTEL'] = 4
	exthdr['COMMENT'] = "This table was written by write_imaging_detector_SC.py"
